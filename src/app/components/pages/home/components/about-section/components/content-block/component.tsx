...
const ContentBlock: React.FC<{className?: string}> = ( { className } ) => {
  return (
    <div className={classnames( 'content-block', className )}>
      ...
      <p>
        I'm a digital nomad and flamboyant creative
        technologist disguised as a web frontend engineer
        living on the road making cool projects.
      </p>
      <br />
      <p>
        I attended Black Hawk College and The Illinois Insitute of Art in Chicago.
